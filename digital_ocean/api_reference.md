...
This document summarizes the major Digital Ocean API endpoints, options, and usage patterns relevant to automating container/app deployment and management for this project. It is intended as a working reference for all scripts and integrations in the `digital_ocean` folder.
