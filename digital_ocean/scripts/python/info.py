...
try:
    ...
    def log_info_query_success(*a, **kw):
        pass

    def log_info_query_error(*a, **kw):
        pass
...
def list_resource_metadata(client):
    ...
    return {
        ...
        "apps": [
            a["spec"]["name"] for a in apps.get("apps", []) if "spec" in a and "name" in a["spec"]
        ],
