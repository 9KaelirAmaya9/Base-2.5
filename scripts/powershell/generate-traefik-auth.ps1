...
Usage examples:
  # Interactive prompts
  powershell -File scripts/powershell/generate-traefik-auth.ps1

  # Non-interactive
  powershell -File scripts/powershell/generate-traefik-auth.ps1 -Username testuser -Password testuser -Algorithm apr1
